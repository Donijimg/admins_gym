# Generated by Django 5.0.2 on 2024-04-20 11:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correo', models.EmailField(max_length=100)),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='solicitudes_clientes', to='gym_registro.admin')),
            ],
        ),
        migrations.CreateModel(
            name='Coach',
            fields=[
                ...
                ('genero', models.CharField(max_length=10)),
                ('turno', models.IntegerField(blank=True, choices=[(1, 'Noche'), (2, 'Dia')], null=True)),
